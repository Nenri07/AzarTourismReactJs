...
// import { generateCVKPDF } from "../../utils/turketPdfUtils";
...
//     setPdfLoading(true);
//     try {
//       await generateCVKPDF(invoice, logo);
...
//         @media print {
//           body { margin: 0; padding: 0; }
//           .cvk-invoice { padding: 30px; box-shadow: none; }
//           .main-table th, .tax-table th { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
//         }
//       `}</style>

//       <div id="cvk-invoice-container" className="cvk-invoice">
//         <div className="header">
//           <div className="logo-box">
...
export default function CVKInvoiceView({ invoiceData }) {
  ...
  const transformInvoiceData = (data) => {
    ...
    otherServices.forEach(service => {
      ...
      // Optionally add 20% VAT line separately if needed
      // transactions.push({
      //   description: "VAT %20",
      //   foreignAmount: "",
      //   date: formatDate(service.date),
      //   debit: formatCurrency(serviceVAT),
      //   credit: "",
      //   vatRate: 20
      // });
    });
