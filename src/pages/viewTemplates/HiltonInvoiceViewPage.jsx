...
// import { InvoiceTemplate } from "../../components";
// // import hiltonInvoiceApi from "../../Api/hiltonInvoice.api"; 
// import logo from "../../../public/Hilton-logo.png";
...
//       fetchInvoiceData();
//     } else {
//       const dummyTransformed = transformInvoiceData({});
//       setInvoice(dummyTransformed);
//       setLoading(false);
//     }
//   }, [invoiceData, invoiceId]);
...
//     try {
//       setLoading(true);
//       // const response = await hiltonInvoiceApi.getInvoiceById(invoiceId);
...
//         dummyCharges.push({
//             id: `txn-${i}`,
//             date: `${day < 10 ? '0'+day : day}/${month < 10 ? '0'+month : month}/2025`,
//             description: "ACCOMMODATION",
//             rate: "500.00 USD",
//             exchangeRate: "* 47.26",
//             refId: "LINTR",
//             refNo: `28532${87 + i}`,
//             guestCharge: "23,630.00",
//             credit: "",
//             amount: ""
//         });
//     }
...
//     return {
//       hotelContact: {
//         name: data?.hotelName || "HILTON ZAMALEK RESIDENCE CAIRO",
//         address: data?.hotelAddress || "21 Mohamed Mazhar St., Zamalek",
//         city: data?.hotelCity || "Cairo, 11211, Egypt",
//         phone: data?.hotelPhone || "T: +20 2 27370055",
//         vat: data?.hotelVat || "VAT: 123-456-789"
//       },
//       guestInfo: {
//         company: data?.company || "AZAR TOURISM",
//         addressLine1: data?.addressLine1 || "ALGERIA SQUARE BUILDING NUMBER",
//         addressLine2: data?.addressLine2 || "12 FIRST FLOOR,",
//         city: data?.city || "TRIPOLI",
//         country: data?.country || "LIBYA",
//         invoiceCopy: data?.invoiceCopy || "255863",
//         confirmationNumber: data?.confirmationNumber || "3350695369",
//         guestName: data?.guestName || "MR RAMADHAN HAMOUDAH",
//         hotelDetails: data?.hotelDetails || "HILTON ZAMALEK RESIDENCE CAIRO 02/12/2025 11:53:00"
//       },
//       roomDetails: {
//         roomNumber: data?.roomNumber || "1245",
//         arrivalDate: data?.arrivalDate || "11/11/2025 00:00",
//         departureDate: data?.departureDate || "02/12/2025 00:00",
//         adultChild: data?.adultChild || "5/0",
//         cashier: data?.cashier || "IPGA/Ibrahim",
//         roomRate: data?.roomRate || "",
//         ratePlan: data?.ratePlan || "IWBB20",
//         al: data?.al || "",
//         hhonors: data?.hhonors || "",
//         vat: data?.vat || "",
//         folio: data?.folio || "243287 A"
//       },
//       totals: {
//         totalEGP: data?.totalEGP || "496,230.00",
//         totalUSD: data?.totalUSD || "10,500.00",
//         balance: data?.balance || "0.00"
//       },
//       charges: data?.charges || dummyCharges
//     };
//   };
...
//             {/* BULLETPROOF HEADER WITH INLINE STYLES */}
//             <div style={{ display: 'flex', justifyContent: 'center', position: 'relative', marginBottom: '20px', width: '100%' }}>
...
//         dummyCharges.push({
//             id: `txn-${i}`,
//             date: `${i < 10 ? '0'+i : i}/11/2025`,
//             description: "ACCOMMODATION",
//             rate: "",
//             exchangeRate: "500.00 USD * 47.26",
//             refId: "LINTR",
//             refNo: `28532${88 + i}`,
//             guestCharge: "23,630.00",
//             credit: "",
...
//         margin: 0,
//         filename: `Hilton_Invoice_${invoice.guestInfo.invoiceCopy}.pdf`,
//         image: { type: 'jpeg', quality: 0.92 }, // fixed: was invalid quality:3, valid range is 0-1
//         html2canvas: {
//           scale: 2,
//           useCORS: true,
//           letterRendering: true,
...
//             {/* Header (Repeated on every page for multipage invoices) */}
//             <div className="header-section">
//               <img src={logo} alt="Hilton Hotels & Resorts" className="logo" />
//             </div>
