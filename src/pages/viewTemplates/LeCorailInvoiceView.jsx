...
// const buildPages = (items = []) => {
//   const MAX_ROWS_NORMAL_PAGE = 32; // Max rows when there is NO footer
//   const MAX_ROWS_WITH_FOOTER = 16; // Max rows when the footer MUST be drawn (footer is tall)
//   const pages = [];
...
//         const grey = index % 2 === 0 ? 'background:#e6e8e9;-webkit-print-color-adjust:exact;print-color-adjust:exact;' : '';
...
//       // ✅ CHANGE 2: financeDeptHTML — line + text now right-aligned
//       const financeDeptHTML = page.isLastPage ? `
//         <div style="margin-top:25px;margin-bottom:10px;width:100%;display:flex;justify-content:flex-end;align-items:flex-end;flex-direction:column;">
//           <div style="border-top:1px solid #777;width:68%;margin-bottom:6px;"></div>
//           <div style="font-size:11.5px;font-family:Arial,Helvetica,sans-serif;text-align:right;">FINANCE DEPARTMENT</div>
//         </div>
...
//       // ✅ CHANGE 1: footerHTML — two-line corporate text on left, SHAYMA on right, no border
//       const footerHTML = `
...
//     /* ✅ CHANGE 3: finance dept container now right-aligned */
//     .lc-finance-dept-container { margin-top: 25px; margin-bottom: 10px; width: 100%; display: flex; justify-content: flex-end; align-items: flex-end; flex-direction: column; }
//     .lc-finance-line { border-top: 1px solid #777; width: 68%; margin-bottom: 6px; }
//     .lc-footer-dept { font-size: 11.5px; font-family: Arial, Helvetica, sans-serif; text-align: right; }
...
//                       <tr>
//                         <th className="lc-col-date">Date</th>
//                         <th className="lc-col-details">Detail</th>
//                         <th className="lc-col-pensio">Pensio</th>
//                         <th className="lc-col-roo">Roo</th>
//                         <th className="lc-col-voucher">Voucher</th>
//                         <th className="lc-col-qty">Qty</th>
...
//                       </div>
//                       <div className="lc-finance-dept-container">
//                         <div className="lc-finance-line" style={{ width: '68%' }}></div>
//                         <div className="lc-footer-dept" style={{paddingRight:"365px" , fontSize:"13px"}}>FINANCE DEPARTMENT</div>
//                       </div>
//                       <div className="lc-footer-tnd">Our invoices are in Tunisian Dinars (TND)</div>
//                       <div className="lc-footer-contact">For any financial information, please contact us by phone or by email : controle2@corail-suites.com</div>
//                     </>
...
//                   {/* ✅ CHANGE 4: Footer — corporate text on left, SHAYMA on right, no border */}
...
const mapApiDataToInvoice = (data = {}) => {
      ...
      if (data.otherServices && data.otherServices.length > 0) {
        data.otherServices
          ...
          .forEach(svc => {
            itemsRaw.push({
              rawDate: accDate,
              client: "Breakfast Room",
              desc: "Petit dejeuner Buffet",
              pensio: "",
              room: acc.room || data.roomNo,
              voucher: "",
  ...
  return {
    meta: {
      invoiceNo: data.invoiceNo || "",
      // CHANGED: dd/mm/yyyy format for the header/meta invoice date
