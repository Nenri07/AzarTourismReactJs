                  ...
                  <div className="calculations-wrapper">
                    <table className="line-items">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colSpan="4" style={{ textAlign: 'right', paddingRight: '10px' , padding: '4px 0px' }}>Total</td>
                          {/* This is the magic part. 'relative' lets it slide out of the column boundaries */}
                          <td className="td-num-right pr-chg-gbp" style={{ position: 'relative', left: '20px' , padding: '4px 0px' }}>
                            {invoice.totals.chgGbp}
                          </td>
                          <td className="td-num-right" style={{ padding: '4px 0px' }}>{invoice.totals.cred}</td>
                        </tr>
                        <tr>
