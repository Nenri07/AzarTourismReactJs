...
// import cairoInvoiceApi from "../../Api/cairoInvoice.api"; // Assuming same API structure
// import toast from "react-hot-toast";
// import html2pdf from 'html2pdf.js';
// import { InvoiceTemplate } from "../../components";
// import logo from '../../../public/Grand_hayat-logo.png'; // Make sure this path and image exist
...
//     // Map Accommodation and Taxes to Debit
...
//     const MAX_ROWS_NORMAL_PAGE = 30; // Max rows when there is NO footer
//     const MAX_ROWS_WITH_FOOTER = 18; // Max rows when the footer MUST be drawn
...
//           .balance-colon { width: 40px; text-align: center; }
//           .balance-currency { width: 30px; text-align: left; }
//           .balance-amount { text-align: right; width: 60px; }
...
//                 </div>
//                 <div className="right-col hotel-info">
//                     {invoice.hotelName || "Grand Hyatt Kuala Lumpur"}<br />
//                     12 Jalan Pinang<br />
//                     50450 Kuala Lumpur, Malaysia<br />
//                     Tel: +603 2182 1234<br />
//                     Fax: +603 2182 1288<br />
//                     Web: kualalumpur.grand.hyatt.com
//                 </div>
//             </div>

//             <div className="flex-row invoice-title-row">
//                 <div className="left-col invoice-title">
...
//                             <tr><td>Cashier / Juruwang</td><td>{invoice.cashierId || "4373/FOSOO"}</td></tr>
//                             <tr><td>Printed / Cetak</td><td>{invoice.formattedInvoiceDate} {invoice.invoiceTime || "13:43:27"}</td></tr>
//                             <tr><td>Page / Mukasurat</td><td>{page.pageNo} of {page.totalPages}</td></tr>
//                             <tr><td>Invoice No / No Invois</td><td>{invoice.folioNo || invoice.referenceNo || "103573"}</td></tr>
//                         </tbody>
//                     </table>
//                 </div>
//             </div>
...
//                                 <td className="col-debit">{formatCurrency(invoice.totalDebit || invoice.grandTotalEgp)}</td>
//                                 <td className="col-credit">{formatCurrency(invoice.totalCredit || invoice.grandTotalEgp)}</td>
//                             </tr>
//                         </>
//                     )}
//                 </tbody>
...
//                                         <td className="balance-colon">:</td>
//                                         <td className="balance-currency">MYR</td>
//                                         <td className="balance-amount">{formatCurrency(invoice.baseTaxableAmount || invoice.grandTotalEgp)}</td>
//                                     </tr>
//                                     <tr>
//                                         <td className="balance-label">SST 6%</td>
//                                         <td className="balance-colon">:</td>
//                                         <td className="balance-currency">MYR</td>
//                                         <td className="balance-amount">{formatCurrency(invoice.serviceCharge || 0)}</td>
//                                     </tr>
//                                     <tr>
//                                         <td className="balance-label">SST 8%</td>
//                                         <td className="balance-colon">:</td>
//                                         <td className="balance-currency">MYR</td>
//                                         <td className="balance-amount">{formatCurrency(invoice.vat14Percent || 0)}</td>
//                                     </tr>
//                                     <tr>
//                                         <td className="balance-label">Tourism Tax</td>
//                                         <td className="balance-colon">:</td>
//                                         <td className="balance-currency">MYR</td>
//                                         <td className="balance-amount">{formatCurrency(invoice.tourismTax || invoice.cityTax || 0)}</td>
//                                     </tr>
//                                 </tbody>
//                             </table>
//                         </div>
...
//                         I agree that I am personally liable for the payment of the following charges if the person, company or association indicated by me as being responsible<br />
//                         for payment of the same does not do so, that my liabilities for such payment shall be joint and several with such person, company or association.<br />
//                         Saya dengan ini bersetuju bertanggungjawab diatas bayaran terhadap perbelanjaan yang dikenakan sekiranya penama, syarikat atau kesatuan yang<br />
//                         dimaklumkan oleh pihak saya tidak melakukannya. Ia adalah menjadi tanggungjawab bersama diantara penama, syarikat atau kesatuan tersebut untuk<br />
//                         menjelaskan bayaran.
//                     </div>
...
//                         Bahagia Investment Corporation (M) Sdn. Bhd. (Co 53091-X)
//                     </div>
//                 </>
//             )}
//           </div>
...
import html2pdf from 'html2pdf.js';
import { InvoiceTemplate } from "../../components";
import logo from '../../../public/Grand-hayat-logo.jpeg'; // Make sure this path and image exist
