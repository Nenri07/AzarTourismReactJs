...
//     /* Info Grid - Exact Left/Right Alignment */
//     .info-grid {
//         display: flex;
//         justify-content: space-between;
//         margin-bottom: 5px;
...
//     /* Right Table - Pushed completely to the right */
//     .info-right {
//         width: 35%;
//         display: flex;
...
//     /* Exact alternating row colors matching the image */
...
//     @media print {
//         .invoice-container { background: none !important; }
//         .inv-page {
...
//                 </tr>
//                 <tr>
//                   <td className="label" style={{paddingTop: "0px" , paddingBottom: "3px"}}>Folyo<br />No</td>
...
//                 {/* Conditionally render totals row on the last page */}
//                 {page.showTotals && (
...
//     @page { 
//         size: A4; 
//         margin: 0; /* Removes browser injected page numbers, date, URL */
//     }
...
//         width: 100%;
//         max-width: 1050px;
//         padding: 40px 40px; /* Keep exact same padding in view and print */
//         margin: 0 auto 24px auto;
//         background: #fff;
//         box-shadow: 0 0 10px rgba(0,0,0,0.1);
//         page-break-after: always;
...
//     /* --- STRICT PRINT STYLES --- */
//     @media print {
//         /* Hide everything by default (buttons, navbars, sidebars) */
//         body * {
//             visibility: hidden;
//         }
        
//         /* Only make the invoice and its children visible */
//         .invoice-container, .invoice-container * {
//             visibility: visible;
//         }
        
//         /* Position the invoice at the absolute top-left of the paper */
//         .invoice-container {
//             position: absolute;
//             left: 0;
//             top: 0;
...
//         .inv-page {
//             box-shadow: none !important;
//             margin: 0 !important; /* Remove spacing between pages */
//             padding: 40px 40px !important; /* Lock exact same padding as view */
//             max-width: 100%;
//             width: 100%;
//             page-break-after: always !important;
//             break-after: page !important;
